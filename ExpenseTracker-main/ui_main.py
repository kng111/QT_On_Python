...
"background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:0, y2:0, stop:0 rgba(97, 97, 97, 255), stop:0.427447 rgba(97, 97, 97, 235), stop:1 rgba(97, 97, 97, 255));\n"
"")

        app_icon = QIcon("balance.ico")
        ...
        self.balances_frame.setStyleSheet(u"background-color: rgba(0, 0, 0, 100); \n"
...
"border: none;")
        ...
        self.balances_frame_2.setStyleSheet(u"background-color: rgba(0, 0, 0, 100); \n"
"border: 1px solid rgba(255,255,255,40);\n"
"border-radius: 7px;")
...
"")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"BalanceAPPs", None))
